...
const UsersPage = ()=>{
    ...
    const handleDeleteUser = async (userId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AxiosUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/user/delete/${userId}`);
            fetchUsers(page);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b167ada._.js.map