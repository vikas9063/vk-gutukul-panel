...
apiClient.interceptors.request.use((config)=>{
    ...
    if (token) {
        if (config.headers?.set) {
            ...
            // When it's still a POJO (depends on build tooling)
            config.headers = {
                ...config.headers,
...
// ----- Response interceptor (includes refresh retry w/ _retry guard) -----
apiClient.interceptors.response.use((response)=>response, async (error)=>{
    const { response, config } = error;
    if (response?.status === 401 && config && !config._retry) {
        config._retry = true; // avoid infinite loop
        try {
            const newToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$AuthService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["refreshToken"])();
            if (newToken) {
                if (config.headers?.set) {
...
"[project]/src/lib/encryptUtils.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const SECRET_KEY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].enc.Utf8.parse("1234567890123456");
const IV = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].enc.Utf8.parse("1234567890123456");
const encrypt = (data)=>{
    const encrypted = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].AES.encrypt(data, SECRET_KEY, {
        iv: IV,
        mode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].mode.CBC,
        padding: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].pad.Pkcs7
    });
    return encrypted.toString(); // Base64 encoded
};
const decrypt = (cipherText)=>{
    const decrypted = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].AES.decrypt(cipherText, SECRET_KEY, {
        iv: IV,
        mode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].mode.CBC,
        padding: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].pad.Pkcs7
    });
    return decrypted.toString(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].enc.Utf8);
};
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$encryptUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/encryptUtils.ts [app-ssr] (ecmascript)");
...
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().email({
    ...
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(6, {
        ...
        message: "Password must not be more than 25 characters."
    })
});
const LoginForm = ({ className, ...props })=>{
    ...
    async function onSubmit(values) {
        const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])(); // Initialize Next.js router
        console.log("Login submit:", values);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AxiosUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/auth/login`, values);
            console.log("Login response:", res.data);
            // Encrypt and store tokens
            if (res.data?.accessToken) {
                localStorage.setItem("TOKEN", (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$encryptUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encrypt"])(res.data.accessToken));
            }
            if (res.data?.refreshToken) {
                localStorage.setItem("REFRESH_TOKEN", (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$encryptUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encrypt"])(res.data.refreshToken));
            }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex flex-col gap-6 items-center justify-center", className),
        ...props,
        children: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd7011bd._.js.map