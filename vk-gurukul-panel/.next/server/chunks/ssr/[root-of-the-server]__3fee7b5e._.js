...
;
;
const BASE_URL = "http://localhost:9595/api/v1";
...
const LoginForm = ({ className, ...props })=>{
    ...
    async function onSubmit(values) {
        console.log(values);
        try {
            let res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AxiosUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post(`/auth/login`, values);
            console.log(res);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3fee7b5e._.js.map