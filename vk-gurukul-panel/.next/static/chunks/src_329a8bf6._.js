...
const UsersPage = ()=>{
    ...
    const handleDeleteUser = async (userId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AxiosUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("/user/delete/".concat(userId));
            fetchUsers(page);
        } catch (error) {
...
_s(UsersPage, "yA9plUXWn7h29PDN+wL4DtQoSQk=");
_c = UsersPage;
...
//# sourceMappingURL=src_329a8bf6._.js.map