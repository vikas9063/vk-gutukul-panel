...
function UserPermissionPage() {
    ...
    const getAllPermissions = async (userPermissionIds)=>{
        try {
            setLoading(true);
            ...
            const enriched = allPermissions.map((perm)=>({
                    ...perm,
                    isCheckedNow: userPermissionIds.includes(perm.id)
                }));
            setPermissionsState(enriched);
        } catch (err) {
    ...
    const handleCheckboxChange = (id, checked)=>{
        setPermissionsState((prev)=>prev.map((perm)=>perm.id === id ? {
                    ...perm,
    ...
    const savePermissions = async ()=>{
        try {
            setSaving(true);
            const permissionIds = permissionsState.filter((perm)=>perm.isCheckedNow).map((perm)=>perm.id);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$AxiosUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/permissions/update-user-permissions", {
                userId,
                permissionIds
            });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserPermissionPage.useEffect": ()=>{
            if (selectedUser === null || selectedUser === void 0 ? void 0 : selectedUser.userId) {
                var _selectedUser_userPermissions;
                const assignedPermissionIds = ((_selectedUser_userPermissions = selectedUser.userPermissions) === null || _selectedUser_userPermissions === void 0 ? void 0 : _selectedUser_userPermissions.map({
                    "UserPermissionPage.useEffect": (p)=>p.id
                }["UserPermissionPage.useEffect"])) || [];
                getAllPermissions(assignedPermissionIds);
            }
        }
    }["UserPermissionPage.useEffect"], [
        selectedUser
    ...
    const groupedPermissions = permissionsState.reduce((acc, perm)=>{
        const [category = "General"] = perm.permissionName.split(":").map((s)=>s.trim());
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                children: [
                    ...
                    selectedUser === null || selectedUser === void 0 ? void 0 : selectedUser.userEmail
                ]
            }, void 0, true, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: perms.map((perm)=>{
                                    var _perm_permissionName_split_;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: ((_perm_permissionName_split_ = perm.permissionName.split(":")[1]) === null || _perm_permissionName_split_ === void 0 ? void 0 : _perm_permissionName_split_.trim()) || perm.permissionName
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/secured/admin/roles/user-permission/[userId]/page.tsx",
                                                        lineNumber: 123,
                                                        columnNumber: 23
...
_s(UserPermissionPage, "6Joxw9p9ZKYb8Dtq13LO2vwmGDc=", false, function() {
    return [
...
//# sourceMappingURL=src_cab37e50._.js.map